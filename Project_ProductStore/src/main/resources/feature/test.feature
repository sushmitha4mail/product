...
@TC02_Project_ProductStore
 ...
 @TC03_Project_ProductStore
  Scenario Outline:Signup in with only username in the ProductStore
...
@TC04_Project_ProductStore
  Scenario Outline:Signup in with only password in the ProductStore
...
@TC15_Project_ProductStore
  Scenario Outline:do not  enter email,name,message and click send
